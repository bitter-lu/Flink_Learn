...
object AppMarketingStatistics01 {
    ...
    class MarketingCountTotal extends ProcessAllWindowFunction
        [MarketingUserBehavior, (Long, Timestamp), TimeWindow] {
        override def process(context: Context,
                             elements: Iterable[MarketingUserBehavior],
                             out: Collector[(Long, Timestamp)]): Unit = {
