...
object RedisExample02 {
    ...
    def main(args: Array[String]): Unit = {
        ...
        stream.addSink(new RedisSink[SensorReading](conf , new RedisExampleMapper02))

        env.execute()
    }

    class RedisExampleMapper02 extends RedisMapper[SensorReading] {
